...
<html lang="en">
    ...
    <center style="width: 100%; table-layout: fixed; background: linear-gradient(135deg, #0b0f17 0%, #131a25 100%); padding: 40px 20px;">
      <table class="container" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr>
          <td class="footer">
            <p class="footer-text">
              &copy; sadiq caps busineess Copyright
            </p>
          </td>
        </tr>
      </table>
  ...
  message: data => {
    const {title = "sadiq caps busineess ", spinner = false, req, description = "Please Wait While We Redirect You To The Right Destination", redirectTime = 3000, redirect = "/index.html"} = data;
...
const sendMail = async (data = {}, req, cb = () => null) => {
  try{
  data = {...{
  subject: `confirm your sadiq caps busineess account`,
