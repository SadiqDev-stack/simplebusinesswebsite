...
import {hash, compareHashes, setCookie, getTokenData, createToken, generateKey, sanitizeInput} from "../utilities/general.js";
...
app.post("/reset/:type",  async (req, res, next) => {
  try{
    ...
    if(typeof email !== "string" || typeof newPassword !== "string" || typeof passCode !== "string") throw new req.AppError("invalid name or transaction pin!")
